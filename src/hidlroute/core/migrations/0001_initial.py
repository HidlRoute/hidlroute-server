    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("state_change_job_logs", models.CharField(blank=True, max_length=100, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("server", models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to="hidl_core.vpnserver")),
                (
                    "service",
                    models.ForeignKey(
                        blank=True,
        ...
        migrations.AddField(
            ...
            name="server",
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to="hidl_core.vpnserver"),
        ),
        migrations.AddField(
            model_name="servertomember",
            name="subnet",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "server",
                    models.ForeignKey(
                        blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to="hidl_core.vpnserver"
                    ),
                ),
                (
                    "server_group",
